...
def boderFrame(img, cnt):
    
    threshold1, threshold2 = 5,10
    
    global DeviceCNT
    if DeviceCNT<=threshold1:
        color = (0,255,0)   #Green
    elif((threshold1<DeviceCNT)and(DeviceCNT<=threshold2)):
